            ...
            <div class="col-xs-12">
                <div class="table-responsive">
                    <table class="table table-bordered table-center">
                        ...
                        ?>
                        <a href='../gold_users' ><button class='btn table_top_btn qizil_xal_btn'>QIZIL XAL TOP 100</button></a>
                        <p class="table_ekran_bildiris_yazisi_p">Bu siyahını tam görmək üçün zəhmət olmasa böyük ekranlı cihazlarla daxil olun.</p>
                        <p class="qirmizi_bildiris_yazisi">Nəzərinizə çatdırırıq ki, günlük xal hər gün sıfırlanaraq ilk 10 yerin sahibinə <span>QIZIL XAL</span> verilir. Ay sonunda qalib, <span>QIZIL XAL</span>'lara əsasən müəyyən olunur. Zəhmət olmasa <a href='../?qaydalar' target="_blank">QAYDALAR</a>'ı oxuyun.</p>
                            <tr>
                                <th>Yer</th>
                        ...
                        <?php
                            ...
                            $yer = 1;
                            if($conn){
                                $select = "SELECT istifadeci_adi,xal,toplam_xal,cinsiyyet FROM istifadeciler WHERE ban_status = 0 ORDER BY xal DESC,toplam_xal DESC LIMIT 100";
                                ...
                                while ($row = mysqli_fetch_assoc($netice)){
                                    ...
                                    echo "<tr ".$reng.">
                                            <td>".$yer."</td>
                                            <td>".substr($row['istifadeci_adi'], 0, -2)."**</td>
                                            <td>".$row['xal']."</td>
